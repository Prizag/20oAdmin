  ...
  return (
    <div className="p-6 bg-slate-50 min-h-screen">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Purchase Tasks</h1>
          <p className="text-sm text-slate-500 mt-1">Sourcing and purchasing queue.</p>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm text-left">
            <thead className="text-xs text-slate-500 uppercase bg-slate-50 border-b border-slate-100">
              <tr><th className="px-6 py-4 font-medium">Task ID</th><th className="px-6 py-4 font-medium">Product</th><th className="px-6 py-4 font-medium">Qty</th><th className="px-6 py-4 font-medium">Budget</th><th className="px-6 py-4 font-medium">Due</th><th className="px-6 py-4 font-medium">Status</th><th className="px-6 py-4 font-medium">Action</th></tr>
            </thead>
            <tbody className="divide-y divide-slate-100 text-slate-700">
              <tr className="hover:bg-slate-50/50 border-b border-slate-50 transition-colors"><td className="px-6 py-4">TSK-101</td><td className="px-6 py-4">Earbuds</td><td className="px-6 py-4">5</td><td className="px-6 py-4">¥45</td><td className="px-6 py-4">2h</td><td className="px-6 py-4"><span className="px-2.5 py-1 rounded-full text-xs font-medium bg-slate-100 text-slate-700">Availability Check</span></td><td className="px-6 py-4">Open</td></tr><tr className="hover:bg-slate-50/50 border-b border-slate-50 transition-colors"><td className="px-6 py-4">TSK-102</td><td className="px-6 py-4">Clock</td><td className="px-6 py-4">2</td><td className="px-6 py-4">¥120</td><td className="px-6 py-4">4h</td><td className="px-6 py-4"><span className="px-2.5 py-1 rounded-full text-xs font-medium bg-amber-100 text-amber-700">Purchase Pending</span></td><td className="px-6 py-4">Open</td></tr>
            </tbody>
          </table>
        </div>
      </div>
