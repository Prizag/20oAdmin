  ...
  return (
    <div className="p-6 bg-slate-50 min-h-screen">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Onboarding Checklist</h1>
          <p className="text-sm text-slate-500 mt-1">Complete your profile to go live.</p>
        </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden mb-6">
        ...
        <div className="p-6">
          <h3 className="text-lg font-medium text-slate-900 mb-4">Business Details Content</h3>
          <p className="text-slate-600">This section allows you to manage business details details. Mock content specifically generated for this tab context.</p>
        </div>
      </div>
