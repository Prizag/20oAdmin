    ...
    <div className="p-6 bg-slate-50 min-h-screen">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">Raise tickets to the platform team.</p>
        </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden mb-6">
        ...
        <div className="p-6">
          <h3 className="text-lg font-medium text-slate-900 mb-4">My Tickets Content</h3>
          <p className="text-slate-600">This section allows you to manage my tickets details. Mock content specifically generated for this tab context.</p>
        </div>
      </div>
